...
const sidebarVariants = cva(
  "fixed inset-y-0 left-0 z-50 flex w-[250px] flex-col bg-background transition-transform duration-300 ease-in-out md:relative md:translate-x-0",
  {
    variants: {
      open: {
        true: "translate-x-0",
...
function Sidebar({ className, ...props }: SidebarProps) {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-40 bg-background/80 backdrop-blur-sm md:hidden" onClick={handleOverlayClick} />
      )}
    </>
  )
}
...
const SidebarMenuButton = React.forwardRef<HTMLButtonElement, SidebarMenuButtonProps>(
  ({ className, isActive, activeClassName, tooltip, asChild = false, ...props }, ref) => {
...
export {
  ...
  SidebarMenuAction,
  SidebarMenuBadge,
  SidebarMenuItem as SidebarMenuItemOld,
  SidebarMenuSkeleton,
  SidebarMenuSub,
